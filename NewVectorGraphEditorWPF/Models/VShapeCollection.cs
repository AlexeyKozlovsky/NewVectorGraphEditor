...
namespace NewVectorGraphEditorWPF.Models {
    ...
    class VShapeCollection : IEnumerable, IEnumerator {
        ...
        public void Add(VShape shape) => this.shapes.Add(shape);

        /// <summary>
        /// Удаляет фигуру из коллекции
        /// </summary>
        /// <param name="shape">Фигура, которую надо удалить</param>
        public void Remove(VShape shape) => this.shapes.Remove(shape);

        /// <summary>
        /// Удаляет фигуру из коллекции
        /// </summary>
        /// <param name="i">Индекс удаляемой фигуры в списке фигур</param>
        public void RemoveAt(int i) => this.shapes.RemoveAt(i);
        ...
        public void Exchange(int i, int j) => (this.shapes[i], this.shapes[j]) = (this.shapes[j], this.shapes[i]);
        ...
        public void Exchange(VShape sh1, VShape sh2) =>
        ...
        public void LiftDown(VShape sh) {
            int i = this.shapes.IndexOf(sh);
        ...
        public void LiftStraightUp(VShape sh) {
            int i = this.shapes.IndexOf(sh);
